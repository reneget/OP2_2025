...
4. Веб-клиент будет доступен на `http://localhost:8080`
...
После запуска откройте браузер и перейдите на `http://localhost:8080`
...
После запуска веб-клиента откройте браузер и перейдите на `http://localhost:8080`. Вы увидите современный веб-интерфейс с следующими возможностями:

1. **Вход/Регистрация** - вкладки для входа или регистрации нового пользователя
2. **Сортировка массива** - интуитивный интерфейс для ввода чисел и выбора направления сортировки
   - Введите числа через пробел
   - Выберите направление сортировки (по возрастанию/убыванию)
   - Результат отображается сразу после выполнения
3. **Просмотр логов** - удобный просмотр логов операций с фильтрацией по периоду

Веб-интерфейс имеет современный дизайн, адаптивную верстку и автоматическую авторизацию через cookies.
